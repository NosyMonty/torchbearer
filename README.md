...
- **Bringer of Death** — melee attacks plus a dodgeable portal-summon ranged attack
...
Full sourcing details and APA7 reference list are included in the project folio. Third-party pixel art, UI, and audio assets were sourced from itch.io creators including adwitr, ansimuz, devkidd, greatdocbrown, Leohpaz, Seliel the Shaper, soulofkiran, and void1gaming — see the folio's Section 5 for the complete declaration.

## Development Note

This project was developed with AI assistance (Claude, by Anthropic) for code implementation, in line with the assessment's AI Level 3 declaration. Full disclosure and reasoning are documented in the project folio.
